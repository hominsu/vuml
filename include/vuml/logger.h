...
#define TRACE(_formatter_, ...) \
  do {                          \
    if (vuml::logger::log_level <= vuml::logger::Level::TRACE) { \
      LOG_BASE(vuml::logger::log_fd, vuml::logger::Level::TRACE, __FILE__, __LINE__, false, _formatter_, ##__VA_ARGS__); \
    }                           \
  } while (0)                   \
  //
...
#define DEBUG(_formatter_, ...) \
  do {                          \
    if (vuml::logger::log_level <= vuml::logger::Level::DEBUG) { \
      LOG_BASE(vuml::logger::log_fd, vuml::logger::Level::DEBUG, __FILE__, __LINE__, false, _formatter_, ##__VA_ARGS__); \
    }                           \
  } while (0)                   \
  //
...
#define INFO(_formatter_, ...) \
  do {                         \
    if (vuml::logger::log_level <= vuml::logger::Level::INFO) { \
      LOG_BASE(vuml::logger::log_fd, vuml::logger::Level::INFO, __FILE__, __LINE__, false, _formatter_, ##__VA_ARGS__); \
    }                          \
  } while (0)                  \
  //
...
#define WARN(_formatter_, ...) \
  do {                         \
    if (vuml::logger::log_level <= vuml::logger::Level::WARN) { \
      LOG_BASE(vuml::logger::log_fd, vuml::logger::Level::WARN, __FILE__, __LINE__, false, _formatter_, ##__VA_ARGS__); \
    }                          \
  } while (0)                  \
  //

#define ERROR(_formatter_, ...) LOG_BASE(vuml::logger::log_fd, vuml::logger::Level::ERROR, __FILE__, __LINE__, false, _formatter_, ##__VA_ARGS__)

#define FATAL(_formatter_, ...) LOG_BASE(vuml::logger::log_fd, vuml::logger::Level::FATAL, __FILE__, __LINE__, true, _formatter_, ##__VA_ARGS__)

#define SYSERR(_formatter_, ...) LOG_SYS(vuml::logger::log_fd, __FILE__, __LINE__, false, _formatter_, ##__VA_ARGS__)

#define SYSFATAL(_formatter_, ...) LOG_SYS(vuml::logger::log_fd, __FILE__, __LINE__, true, _formatter_, ##__VA_ARGS__)
